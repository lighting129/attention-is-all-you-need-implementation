...
class SelfAttention(nn.Module):
    ...
    def forward(self , values , keys , query , mask):
        ...
        #spilt embedding into self.heads pieces
        ...
        #enery shape :(N, heads, query_len, keys_len)
...
if __name__ == "__main__":
    ...
    [2, 3, 8, 6, 1, 7, 4, 0, 0],
    [5, 1, 9, 4, 6, 2, 3, 0, 0],
    [3, 5, 6, 7, 8, 1, 9, 0, 0]]).to(device)
    trg = torch.tensor([
    [2, 9, 4, 5, 3, 7, 1, 0],
    [6, 8, 3, 1, 7, 5, 4, 0],
    [4, 5, 6, 2, 3, 8, 7, 0]]).to(device)
